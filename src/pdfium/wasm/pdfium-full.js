/**
 * PDFium Full WASM loader placeholder.
 *
...
export default function loadPdfiumFull(_options) {
  return Promise.reject(
    new Error(
      'PDFium Full WASM not yet built. Run the "Build PDFium WASM" GitHub Actions workflow or build locally with Docker.',
    ),
  );
}
