...
[@noto-pdf-ts/core](../core) で使用するための Noto Sans Traditional Chinese Variable Font パッケージです。
...
- **フォント名**: Noto Sans Traditional Chinese Variable Font
- **ファイル**: NotoSansTC-VF.ttf（約9MB）
- **対応文字**: 繁体字中国語（漢字）、ラテン文字
