...
/** Font file name for Noto Sans Kannada */
export const FONT_NAME = 'NotoSansKannada[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Kannada font configuration.
 *
 ...
 * import loadKannada from '@noto-pdf-ts/fonts-all/kannada'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadKannada()])
 * ```
 */
