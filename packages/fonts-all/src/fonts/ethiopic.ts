...
/** Font file name for Noto Sans Ethiopic */
export const FONT_NAME = 'NotoSansEthiopic[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Ethiopic font configuration (Amharic, Tigrinya, etc.).
 *
 ...
 * import loadEthiopic from '@noto-pdf-ts/fonts-all/ethiopic'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadEthiopic()])
 * ```
 */
