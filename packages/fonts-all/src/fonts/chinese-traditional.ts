...
/** Font file name for Noto Sans Traditional Chinese */
...
/**
 * Load the Noto Sans Traditional Chinese font configuration.
 *
 ...
 * import loadChineseTraditional from '@noto-pdf-ts/fonts-all/chinese-traditional'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadChineseTraditional()])
 * ```
 */
