...
/** Font file name for Noto Sans (Latin, Greek, Cyrillic) */
export const FONT_NAME = 'NotoSans[wdth,wght].ttf';
...
/**
 * Load the Noto Sans font configuration (Latin, Greek, Cyrillic scripts).
 *
 ...
 * import loadLatin from '@noto-pdf-ts/fonts-all/latin'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadLatin()])
 * ```
 */
