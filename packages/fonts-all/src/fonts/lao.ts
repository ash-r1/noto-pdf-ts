...
/** Font file name for Noto Sans Lao */
export const FONT_NAME = 'NotoSansLao[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Lao font configuration.
 *
 ...
 * import loadLao from '@noto-pdf-ts/fonts-all/lao'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadLao()])
 * ```
 */
