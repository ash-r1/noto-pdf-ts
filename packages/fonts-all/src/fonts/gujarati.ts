...
/** Font file name for Noto Sans Gujarati */
export const FONT_NAME = 'NotoSansGujarati[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Gujarati font configuration.
 *
 ...
 * import loadGujarati from '@noto-pdf-ts/fonts-all/gujarati'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadGujarati()])
 * ```
 */
