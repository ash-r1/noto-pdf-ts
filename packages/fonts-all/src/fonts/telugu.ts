...
/** Font file name for Noto Sans Telugu */
export const FONT_NAME = 'NotoSansTelugu[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Telugu font configuration.
 *
 ...
 * import loadTelugu from '@noto-pdf-ts/fonts-all/telugu'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadTelugu()])
 * ```
 */
