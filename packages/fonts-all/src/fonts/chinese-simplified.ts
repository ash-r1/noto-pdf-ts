...
/** Font file name for Noto Sans Simplified Chinese */
...
/**
 * Load the Noto Sans Simplified Chinese font configuration.
 *
 ...
 * import loadChineseSimplified from '@noto-pdf-ts/fonts-all/chinese-simplified'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadChineseSimplified()])
 * ```
 */
