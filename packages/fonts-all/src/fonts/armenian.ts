...
/** Font file name for Noto Sans Armenian */
export const FONT_NAME = 'NotoSansArmenian[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Armenian font configuration.
 *
 ...
 * import loadArmenian from '@noto-pdf-ts/fonts-all/armenian'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadArmenian()])
 * ```
 */
