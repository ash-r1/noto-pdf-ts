...
/** Font file name for Noto Sans Arabic */
export const FONT_NAME = 'NotoSansArabic[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Arabic font configuration.
 *
 ...
 * library.registerFonts([await loadArabic()])
 * ```
 */
