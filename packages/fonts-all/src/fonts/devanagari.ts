...
/** Font file name for Noto Sans Devanagari */
export const FONT_NAME = 'NotoSansDevanagari[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Devanagari font configuration (Hindi, Sanskrit, Marathi, etc.).
 *
 ...
 * import loadDevanagari from '@noto-pdf-ts/fonts-all/devanagari'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadDevanagari()])
 * ```
 */
