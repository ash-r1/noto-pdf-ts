...
/** Font file name for Noto Sans Sinhala */
export const FONT_NAME = 'NotoSansSinhala[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Sinhala font configuration (Sri Lanka).
 *
 ...
 * import loadSinhala from '@noto-pdf-ts/fonts-all/sinhala'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadSinhala()])
 * ```
 */
