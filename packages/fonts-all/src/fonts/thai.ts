...
/** Font file name for Noto Sans Thai */
export const FONT_NAME = 'NotoSansThai[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Thai font configuration.
 *
 ...
 * import loadThai from '@noto-pdf-ts/fonts-all/thai'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadThai()])
 * ```
 */
