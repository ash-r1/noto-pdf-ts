...
/** Font file name for Noto Sans Oriya */
export const FONT_NAME = 'NotoSansOriya[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Oriya font configuration (Odia script).
 *
 ...
 * import loadOriya from '@noto-pdf-ts/fonts-all/oriya'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadOriya()])
 * ```
 */
