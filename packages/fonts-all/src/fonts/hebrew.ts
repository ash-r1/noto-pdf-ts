...
/** Font file name for Noto Sans Hebrew */
export const FONT_NAME = 'NotoSansHebrew[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Hebrew font configuration.
 *
 ...
 * import loadHebrew from '@noto-pdf-ts/fonts-all/hebrew'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadHebrew()])
 * ```
 */
