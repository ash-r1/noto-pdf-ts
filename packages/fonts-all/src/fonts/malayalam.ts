...
/** Font file name for Noto Sans Malayalam */
export const FONT_NAME = 'NotoSansMalayalam[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Malayalam font configuration.
 *
 ...
 * import loadMalayalam from '@noto-pdf-ts/fonts-all/malayalam'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadMalayalam()])
 * ```
 */
