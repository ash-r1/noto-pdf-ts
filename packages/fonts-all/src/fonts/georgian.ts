...
/** Font file name for Noto Sans Georgian */
export const FONT_NAME = 'NotoSansGeorgian[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Georgian font configuration.
 *
 ...
 * import loadGeorgian from '@noto-pdf-ts/fonts-all/georgian'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadGeorgian()])
 * ```
 */
