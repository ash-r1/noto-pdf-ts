...
/** Font file name for Noto Sans Gurmukhi */
export const FONT_NAME = 'NotoSansGurmukhi[wdth,wght].ttf';
...
/**
 * Load the Noto Sans Gurmukhi font configuration (Punjabi).
 *
 ...
 * import loadGurmukhi from '@noto-pdf-ts/fonts-all/gurmukhi'
 *
 * const library = await PDFiumLibrary.init()
 * library.registerFonts([await loadGurmukhi()])
 * ```
 */
