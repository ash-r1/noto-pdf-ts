...
[@noto-pdf-ts/core](../core) で使用するための Noto Sans Japanese Variable Font パッケージです。
...
- **フォント名**: Noto Sans Japanese Variable Font
- **ファイル**: NotoSansJP-VF.ttf（約9MB）
- **対応文字**: ひらがな、カタカナ、漢字、ラテン文字
